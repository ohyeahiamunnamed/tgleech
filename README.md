...
[<img src="https://deploy.cloud.run/button.svg" alt="Run on Google Cloud" height="40"/>](https://deploy.cloud.run?git_repo=https://github.com/ohyeahiamunnamed/tgleech.git "Google Cloud")
[<img src="https://www.herokucdn.com/deploy/button.svg" alt="Deploy to Heroku" height="40"/>](https://heroku.com/deploy?template=https://github.com/ohyeahiamunnamed/tgleech "Heroku")
...
# get botkaca source
git clone https://github.com/ohyeahiamunnamed/tgleech.git

# build then execute using docker image
docker build -t ohyeahiamunnamed/tgleech
docker run -it ohyeahiamunnamed/tgleech
```
